...
const brandColors = [
  ...
  { name: "Sky", variable: "--sky", hex: "#4497C3", description: "Confiança e serenidade" },
  { name: "Sky Light", variable: "--sky-light", hex: "#B8D6E8" },
  { name: "Sky Dark", variable: "--sky-dark", hex: "#2B6F96" },
