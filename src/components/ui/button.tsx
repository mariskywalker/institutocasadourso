  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-semibold ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 font-display",
  {
    variants: {
      variant: {
        ...
        mint: "bg-mint text-primary-foreground hover:bg-mint/90 hover:-translate-y-0.5 transition-all shadow-soft",
        hero: "bg-mint text-primary-foreground hover:bg-mint/90 shadow-elevated hover:-translate-y-1 hover:shadow-card transition-all duration-300",
        "outline-mint": "border-2 border-mint bg-transparent text-mint hover:bg-mint hover:text-primary-foreground transition-all",
